...
#
# Script generated by Vivado on Thu Apr 24 14:43:08 -0400 2025
...
#
# Usage        : Wrapper.sh
#                Wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Wrapper.sh [-reset_run]
#                Wrapper.sh [-reset_log]
#                Wrapper.sh [-help]
#
...
# script info
echo -e "Wrapper.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot Wrapper xil_defaultlib.Wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Wrapper -key {Behavioral:sim_1:Functional:Wrapper} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Wrapper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Wrapper.sh [-help]\n\
Usage: Wrapper.sh [-step]\n\
Usage: Wrapper.sh [-lib_map_path]\n\
Usage: Wrapper.sh [-reset_run]\n\
Usage: Wrapper.sh [-reset_log]\n\
Usage: Wrapper.sh [-keep_index]\n\
Usage: Wrapper.sh [-noclean_files]\n\n\
